...
public class EzJobUtil {
     ...
     */
    public static void loadEzbakeConfigurations(Configuration configToAddTo) throws EzConfigurationLoaderException {
            ...
            loadEzbakeConfigurations(ezConfiguration.getProperties(), configToAddTo);
    }
     ...
     * @param configToAddTo The Configuration to add the config values to
     */
    public static void loadEzbakeConfigurations(Properties ezConfiguration, Configuration configToAddTo)  {
